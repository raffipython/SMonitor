...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        intentFilter.addAction("com.tools.smonitor");
    ...
    private void changeInterceptedNotificationImage(int notificationCode){
        switch(notificationCode){
            ...
            case NotificationListenerExampleService.InterceptedNotificationCode.SIGNAL_CODE:
                interceptedNotificationImageView.setImageResource(R.drawable.instagram_logo); // fix me
                break;
              /*
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String TA = this.getClass().getSimpleName();
        Log.i(TA, "TEST MAIN");
    }
